...
$page = $_GET['single'];
$query = mysqli_query($conn, "SELECT * FROM `news` WHERE `id` = '".$page."'");
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        <b><?php echo $title;?></b>
        <p class="blog-post-meta"><?php echo $date;?> by <a href="#"><?php echo $admin;?></a></p>
        <p><?php echo $category;?></p>
          <center><img class="img img-thumbnail" width="250px" height="250px" src="images\<?php echo $thumbnail;?>" alt="<?php echo "images/".$thumbnail;?>"></center>    
